...
public class Owner
{
    ...
    /// <summary>
    /// Creates valid demo data with a stable identifier. Production owners should use the
    /// normal constructor so their identifiers are generated by the domain.
    /// </summary>
    public static Owner Seed(Guid ownerId, string ownerName, string email, string phone, string? address)
    {
        ...
        var owner = new Owner(ownerName, email, phone, address);
